			...
			<fieldset>
				<div class="mb-4">
					...
					<div class="block relative">
						<select
							name="categories"
							id="categories"
							class="appearance-none bg-white block border border-gray-400 focus:outline-none focus:shadow-outline hover:border-gray-500 leading-tight px-4 py-3 pr-8 rounded shadow w-full"
							on:change={handleSelectInput}
						>
				...
				<div class="mb-4">
					...
					<input
						...
						min={1}
						max={10}
						class="block border border-gray-400 focus:outline-none focus:bg-white hover:border-gray-500 leading-tight mb-3 px-4 py-3 rounded shadow w-full"
						bind:value={form.timeInMinutes}
